      ...
      <section className="about-us" id="about-us">
        ...
        <div className="about-us-cards">
          ...
          <div className="about-us-card">
            <img src="/Manu Rana.jpg" alt="Team Member 1" className="about-us-image" />
            <h3 className="about-us-member-name">Manu Rana</h3>
            <p className="about-us-member-work">Frontend Developer</p>
          </div>
          <div className="about-us-card">
            <img src="/Shreyansh Tiwari.jpg" alt="Team Member 2" className="about-us-image" />
            <h3 className="about-us-member-name">Shreyansh Tiwari</h3>
            <p className="about-us-member-work">Frontend Developer</p>
          </div>
          <div className="about-us-card">
            <img src="/Yug Jain.jpg" alt="Team Member 3" className="about-us-image" />
            <h3 className="about-us-member-name">Yug Jain</h3>
            <p className="about-us-member-work">Backend Developer</p>
          </div>
          <div className="about-us-card">
            <img src="/Aryan.jpg" alt="Team Member 4" className="about-us-image" />
            <h3 className="about-us-member-name">Aryan</h3>
            <p className="about-us-member-work">Frontend Developer</p>
          </div>
          <div className="about-us-card">
            <img src="/Shubh Parashar.jpg" alt="Team Member 5" className="about-us-image" />
            <h3 className="about-us-member-name">Shubh Parashar</h3>
            <p className="about-us-member-work">Backend Developer</p>
          </div>
        </div>
      </section>
